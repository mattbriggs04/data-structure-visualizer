        ...
        <div className="description-wrapper">
            {structure == "linkedlist" &&
                <div className="description-container linkedlist-desc-container">
                    ...
                    <p>Linked list are a fundamental data structure that store information in nodes, in which each node is <em>linked</em> to eachother through a pointer to the next (sometimes also the previous) node. <blockquote>Currently, the linked list shown in the visualizer is a singly linked list, which means each element is only linked to the next element. A doubly linked list would </blockquote>
                    </p>
                </div>
            }
            {structure == "bst" &&
